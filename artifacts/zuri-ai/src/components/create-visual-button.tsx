...
export function CreateVisualButton({
  ...
  const [pos, setPos]   = useState<DropdownPos>({ top: 0, left: 0, openUp: true });
  ...
  function calcPos() {
    ...
    const top  = openUp ? r.top - menuH - 6  : r.bottom + 6;
  ...
  const dropdown = open ? createPortal(
    <div
      ...
      className="bg-card border border-border rounded-2xl shadow-2xl p-2 space-y-0.5"
    >
        ...
        return (
          <button
            ...
            className={cn(
              ...
              isSuggested ? "bg-primary/8 hover:bg-primary/12" : "hover:bg-muted",
            )}
          >
